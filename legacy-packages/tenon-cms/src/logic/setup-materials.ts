...
import { IMaterial, setupConfigSchemas, setupWebComponents } from "@tenon/legacy-materials";
...
import { ISchema, TenonComponent, TenonPropsBinding, TenonStore } from "@tenon/legacy-engine";
